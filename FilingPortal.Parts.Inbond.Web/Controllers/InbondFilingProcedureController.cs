...
using Permissions = FilingPortal.Parts.Inbond.Domain.Enums.Permissions;
...
namespace FilingPortal.Parts.Inbond.Web.Controllers
{
    ...
    /// </summary>
    [RoutePrefix("api/zones/in-bond/filing")]
    public class InbondFilingProcedureController : ApiControllerBase
    {
        /// <summary>
        ...
        /// </summary>
        private readonly IFilingHeaderRepository _filingHeaderRepository;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InbondFilingProcedureController"/> class
        /// </summary>
        ...
        public InbondFilingProcedureController(
            IFilingService<InboundRecord> procedureService,
            IFilingHeaderRepository filingHeaderRepository,
        ...
        public IHttpActionResult Start([FromBody] int[] ids)
        {
            using (new MonitoredScope("Starting Filing process"))
            {
                ...
                {
                    FilingHeader currentHeader = filingHeaders.FirstOrDefault(x => x.InbondRecords.Any(y => y.Id == id));
        ...
        {
            return _filingHeaderRepository.GetList(filingHeaderIds).SelectMany(x => x.InbondRecords.Select(t => t.Id));
        }
