...
namespace FilingPortal.Parts.Inbond.Web.Controllers
{
    ...
    /// </summary>
    [RoutePrefix("mvc/zones/in-bond/filing")]
    public class InbondFilingActionsController : Controller
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InbondFilingActionsController" /> class
        /// </summary>
        ...
        public InbondFilingActionsController(
