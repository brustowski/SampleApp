...
namespace Framework.Infrastructure
{
    public static class PropertyExpressionHelper
    {
        ...
        public static Type GetPropertyType<T, TValue>(Expression<Func<T, TValue>> expression)
        {
            var unary = expression.Body as UnaryExpression;
            MemberExpression member = expression.Body as MemberExpression ?? unary?.Operand as MemberExpression;
            if (member != null)
                return member.Type;
