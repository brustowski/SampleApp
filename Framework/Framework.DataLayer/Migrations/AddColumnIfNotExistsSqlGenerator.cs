        ...
        protected override void Generate(MigrationOperation migrationOperation)
        {
            ...
            using (var writer = Writer())
            {
                ...
                if (column.IsNullable != null
                    ...
                    && !column.IsIdentity
                    && !column.IsTimestamp
                    && !column.StoreType.Equals("rowversion", StringComparison.InvariantCultureIgnoreCase)
                    && !column.StoreType.Equals("timestamp", StringComparison.InvariantCultureIgnoreCase))
                {
