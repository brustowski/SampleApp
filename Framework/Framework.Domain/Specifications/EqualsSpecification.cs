   ...
   public class EqualsSpecification<T> : SpecificationBase<T> where T : class 
    {
        ...
        public override Expression<Func<T, bool>> GetExpression()
        {
            ...
            if (type.IsEnum)
            {
                expression = Expression.Convert(memberExp, typeof(byte));
            ...
            var equalExpression = Expression.Equal(Expression.Constant(_value).ConvertTypeIfNullable(memberExp), expression);
