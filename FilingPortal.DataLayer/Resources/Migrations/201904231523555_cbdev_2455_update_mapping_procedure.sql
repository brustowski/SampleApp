ALTER TABLE dbo.Pipeline_DeclarationTab
  ADD EntryNumber varchar(11) NULL
GO

SET DATEFORMAT ymd
INSERT INTO dbo.Pipeline_DEFValues(Display_on_UI, ValueLabel, TableName, ColName, FManual, FHasDefaultVal, FEditable, UI_Section, FMandatory) VALUES(100, N'Entry #', N'Pipeline_DeclarationTab', N'EntryNumber', 0, 0, 1, N'01.Declaration', 0)
GO
