...
SET CW_CreatedDateUTC = edi.EM_SystemCreateTimeUtc
FROM Rail_BD_Parsed rbp INNER JOIN Rail_EDIMessage edi ON rbp.BDP_EM = edi.EM_PK
GO
...
AS SELECT DISTINCT
 ...
 ,bd_parsed.CW_CreatedDateUTC BD_Parsed_CreatedDate
