...
--
GO
CREATE FUNCTION dbo.fn_extract_api_from_customs_attribute (@custAttr VARCHAR(50))
...
--
GO
CREATE FUNCTION dbo.fn_convert_weight (@value DECIMAL(18, 9), @inbndUnit VARCHAR(2), @returnUnit VARCHAR(2))
