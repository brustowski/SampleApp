CREATE PROCEDURE dbo.sp_cw_get_domestic_ports
AS
BEGIN
...
SELECT DISTINCT PORTCODE,UNLOCO,Country FROM
 (
        ...
        OVER (PARTITION BY RY_LocalPortCode,RL_RN_NKCountryCode,ST.RW_Code ORDER BY RY_RL_NKLocoPort ASC) AS SortRank
        FROM reflocomap map
