...
BEGIN
  ...
  FETCH NEXT FROM cur INTO @recordId, @jobHeaderStatus, @importDate, @exportDate, @releaseDate, @psd, @paymentDue, @endStatusDescription, @supplierMid, @manufacturerMid, @containersCount, @grossWeightUnit
