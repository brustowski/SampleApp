...
using FilingPortal.Parts.Zones.Entry.Domain.Services;
...
namespace FilingPortal.Parts.Zones.Entry.Web.Controllers
{
    ...
    public class ZonesEntryImportController : ApiControllerBase
    {
        /// <summary>
        /// File import service
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZonesEntryImportController"/> class.
        /// </summary>
        ...
        public ZonesEntryImportController(IXmlFileImportService importService, IInboundXmlRepository xmlRepository)
        {
        ...
        {
            string folder = DirectoryHelpers.EnsureWorkingFolder("FilingPortal/Upload");
        ...
        /// <summary>
        /// Parse and validate the uploaded XML files with Zones Entry 06 record
        /// </summary>
        /// <param name="request">The request</param>
        [Route("upload-xml")]
        [HttpPost]
