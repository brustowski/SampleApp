...
namespace FilingPortal.Parts.Zones.Entry.Web.Controllers
{
    ...
    /// </summary>
    [RoutePrefix("api/rules/zones/entry-06/default-values")]
    public class ZonesEntryDefaultValuesController : DefaultValuesControllerBase<DefValueReadModel, DefValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ZonesEntryDefaultValuesController" /> class
        /// </summary>
        ...
        public ZonesEntryDefaultValuesController(
