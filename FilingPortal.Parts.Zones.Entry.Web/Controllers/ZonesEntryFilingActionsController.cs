...
namespace FilingPortal.Parts.Zones.Entry.Web.Controllers
{
    ...
    /// </summary>
    [RoutePrefix("mvc/zones/entry-06/filing")]
    public class ZonesEntryFilingActionsController : Controller
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZonesEntryFilingActionsController" /> class
        /// </summary>
        ...
        public ZonesEntryFilingActionsController(
