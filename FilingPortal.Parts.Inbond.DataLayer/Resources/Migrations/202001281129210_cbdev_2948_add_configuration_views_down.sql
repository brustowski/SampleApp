DROP VIEW inbond.v_report;
GO

DROP VIEW inbond.v_field_configuration;
GO

DROP VIEW inbond.v_form_configuration;
GO

TRUNCATE TABLE inbond.form_configuration;
GO

ALTER TABLE inbond.form_section_configuration
DROP CONSTRAINT [FK_inbond.form_section_configuration_inbond.form_section_configuration_parent_id]
DELETE FROM inbond.form_section_configuration;
ALTER TABLE inbond.form_section_configuration
ADD CONSTRAINT [FK_inbond.form_section_configuration_inbond.form_section_configuration_parent_id] FOREIGN KEY (parent_id) REFERENCES inbond.form_section_configuration (id)
GO
