import {
  Component, Output, EventEmitter, Input, HostBinding, ChangeDetectorRef, ChangeDetectionStrategy, SkipSelf
} from '@angular/core';
...
export class DataTableHeaderComponent {
  ...
  calcStylesByGroup(group: string): any {
    ...
    if (group === 'center') {
      ...
      const scrollBarWidth = this.scrollbarV ? this.scrollbarHelper.width : 0;
      const totalDiff = widths.total - this.innerWidth;
      const offset = (totalDiff + scrollBarWidth) * -1;
