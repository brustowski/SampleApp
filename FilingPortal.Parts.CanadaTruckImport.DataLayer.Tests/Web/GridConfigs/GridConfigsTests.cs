...
namespace FilingPortal.Parts.CanadaTruckImport.DataLayer.Tests.Web.GridConfigs
{
    [TestClass]
    public class GridConfigsTests: GridConfigsTestsBase
    {
        public override Assembly ConfigsAssembly => Assembly.GetAssembly(typeof(CanadaTruckImport.Web.AutofacModule));
