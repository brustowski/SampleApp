...
namespace FilingPortal.Web.PageConfigs.TruckExport
{
    ...
    /// <summary>
    /// Represents the Import action availability rule for Truck Export View Page Configuration
    /// </summary>
    public class TruckExportViewPageImportRule : IAvailableRule<PageConfigurationModel>
    {
        /// <summary>
