...
namespace FilingPortal.Web.PageConfigs.Vessel
{
    ...
    /// <summary>
    /// Represents the Import action availability rule for Vessel View Page Configuration
    /// </summary>
    public class VesselViewPageAddImportRecord : IAvailableRule<PageConfigurationModel>
    {
        /// <summary>
        /// Defines required permissions
        /// </summary>
        private readonly Permissions[] _permissions = new[] { Permissions.VesselAddImportRecord };
