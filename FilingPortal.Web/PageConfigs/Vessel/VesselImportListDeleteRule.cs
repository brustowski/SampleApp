...
{
    /// <summary>
    /// Class describing the Delete action availability for the list of the Vessel Inbound Records
    /// </summary>
    public class VesselImportListDeleteRule : IAvailableRule<List<VesselImportReadModel>>
    {
        /// <summary>
