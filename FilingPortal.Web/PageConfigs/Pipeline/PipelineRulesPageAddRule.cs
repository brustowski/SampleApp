...
{
    /// <summary>
    /// Class describing the Add action availability for the Pipeline Page Configuration
    /// </summary>
    public class PipelineRulesPageAddRule : IAvailableRule<PageConfigurationModel>
    {
        /// <summary>
        /// Defines required permissions
        /// </summary>
        private readonly Permissions[] _permissions = new[] { Permissions.PipelineEditInboundRecordRules};
