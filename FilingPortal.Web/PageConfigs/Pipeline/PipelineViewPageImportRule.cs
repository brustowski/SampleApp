...
{
    /// <summary>
    /// Represents the Import action availability rule for Pipeline View Page Configuration
    /// </summary>
    public class PipelineViewPageImportRule : IAvailableRule<PageConfigurationModel>
    {
        /// <summary>
