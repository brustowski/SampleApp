...
{
    /// <summary>
    /// Class describing the Edit action availability for Vessel Export Record list
    /// </summary>
    public class VesselExportListEditRule : IAvailableRule<List<VesselExportReadModel>>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether the Edit action is available for the specified list of Vessel Export Record models
        /// </summary>
