...
{
    /// <summary>
    /// Class describing the Review and File action availability for Vessel Export Record list
    /// </summary>
    public class VesselExportListReviewFileRule : IAvailableRule<List<VesselExportReadModel>>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether the Review and File action is available for the specified list of Vessel Export Record models
        /// </summary>
