...
{
    /// <summary>
    /// Class describing the Delete action availability for Truck Rule Record
    /// </summary>
    public class TruckRuleDeleteRule : IAvailableRule<IRuleEntity>
    {
        /// <summary>
        /// Defines required permissions
        /// </summary>
        private readonly Permissions[] _permissions = { Permissions.TruckDeleteInboundRecordRules };
