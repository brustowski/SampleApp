...
namespace FilingPortal.Web.PageConfigs.Truck
{
    ...
    /// <summary>
    /// Reprents the Import action availability rule for Truck View Page Configuration
    /// </summary>
    public class TruckViewPageImportRule : IAvailableRule<PageConfigurationModel>
    {
        /// <summary>
