...
namespace FilingPortal.Web.PageConfigs.Rail
{
    ...
    /// </summary>
    public class RailBdParsedViewManifestRule : IAvailableRule<RailInboundReadModel>
    {
        /// <summary>
        /// Defines required permissions
        /// </summary>
        private readonly Permissions[] _permissions = new[] { Permissions.RailViewManifest};
