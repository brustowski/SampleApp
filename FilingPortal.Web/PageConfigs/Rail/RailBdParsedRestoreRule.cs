...
{
    /// <summary>
    /// Class describing the Restore action availability for Inbound Record
    /// </summary>
    public class RailBdParsedRestoreRule : IAvailableRule<RailInboundReadModel>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether the restore action is available for the specified model
        /// </summary>
