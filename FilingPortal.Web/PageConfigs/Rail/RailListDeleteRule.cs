...
{
    /// <summary>
    /// Class describing the Delete action availability for the list of the Rail Inbound Records
    /// </summary>
    public class RailListDeleteRule : IAvailableRule<List<RailInboundReadModel>>
    {
        /// <summary>
