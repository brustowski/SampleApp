...
{
    /// <summary>
    /// Validator for <see cref="RailRuleImporterSupplierEditModel"/>
    /// </summary>
    public class RailRuleImporterSupplierEditModelValidator : AbstractValidator<RailRuleImporterSupplierEditModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RailRuleImporterSupplierEditModelValidator"/> class
        /// </summary>
        ...
        public RailRuleImporterSupplierEditModelValidator(IClientRepository repository, IClientAddressRepository addressRepository, ILookupMasterRepository<LookupMaster> portRepository)
        {
