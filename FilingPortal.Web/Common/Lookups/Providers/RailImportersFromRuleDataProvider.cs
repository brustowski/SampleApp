...
{
    /// <summary>
    /// Provider for Rail Importer-Supplier rule Importers
    /// </summary>
    public class RailImportersFromRuleDataProvider : ILookupDataProvider
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RailImportersFromRuleDataProvider"/> class
        /// </summary>
        /// <param name="repository">Importer-supplier rules repository</param>
        public RailImportersFromRuleDataProvider(IRailRuleImporterSupplierRepository repository)
        {
        ...
        /// </summary>
        public string Name => DataProviderNames.RailRuleImporterNames;
        ...
        public IEnumerable<LookupItem> GetData(SearchInfo searchInfo)
        {
            ...
            IList<string> data = _repository.GetImporters(searchData); // Already sorted
