...
namespace FilingPortal.Web.Controllers.TruckExport
{
    ...
    /// </summary>
    [RoutePrefix("api/rules/export/truck/consignee")]
    public class TruckExportRuleConsigneeController : RuleControllerBase<TruckExportRuleConsignee, TruckExportRuleConsigneeViewModel, TruckExportRuleConsigneeEditModel>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TruckExportRuleConsigneeController" /> class
        /// </summary>
        ...
        public TruckExportRuleConsigneeController(
            IPageConfigContainer pageConfigContainer,
            ISearchRequestFactory searchRequestFactory,
            IRuleRepository<TruckExportRuleConsignee> repository,
            IRuleService<TruckExportRuleConsignee> ruleService,
            IRuleValidator<TruckExportRuleConsignee> ruleValidator
            )
        ...
        [Route("search")]
        [PermissionRequired(Permissions.TruckViewExportRecordRules)]
        public override Task<SimplePagedResult<TruckExportRuleConsigneeViewModel>> Search([FromBody]SearchRequestModel data) => base.Search(data);
        ...
        public override ValidationResultWithFieldsErrorsViewModel Update([FromBody] TruckExportRuleConsigneeEditModel model) => base.Update(model);
        ...
        [Route("create")]
        [PermissionRequired(Permissions.TruckEditExportRecordRules)]
        public override ValidationResultWithFieldsErrorsViewModel Create([FromBody] TruckExportRuleConsigneeEditModel model) => base.Create(model);
        ...
        [Route("getNew")]
        [PermissionRequired(Permissions.TruckEditExportRecordRules)]
        public override TruckExportRuleConsigneeViewModel GetNewRow() => base.GetNewRow();
        ...
        {
            result.AddFieldError(PropertyExpressionHelper.GetPropertyName<TruckExportRuleConsigneeEditModel>(x => x.ConsigneeCode),
                string.Empty);
        }
    }
}