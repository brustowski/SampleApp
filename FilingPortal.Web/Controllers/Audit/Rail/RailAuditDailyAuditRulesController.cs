...
{
    /// <summary>
    /// Controller for Rail Audit - Daily audit rules
    /// </summary>
    [RoutePrefix("api/audit/rail/daily-audit-rules")]
    public class RailAuditDailyAuditRulesController : RuleControllerBase<AuditRailDailyRule, DailyAuditRuleViewModel, DailyAuditRuleEditModel>
    {
        /// <summary>
        ...
        public RailAuditDailyAuditRulesController(
            IPageConfigContainer pageConfigContainer,
            ISearchRequestFactory searchRequestFactory,
            IRuleRepository<AuditRailDailyRule> repository,
            IRuleService<AuditRailDailyRule> ruleService,
            IRuleValidator<AuditRailDailyRule> ruleValidator) : base(pageConfigContainer, searchRequestFactory, repository, ruleService, ruleValidator)
        { }
        ...
        [Route("search")]
        [PermissionRequired(Permissions.AuditRailDailyAudit)]
        public override Task<SimplePagedResult<DailyAuditRuleViewModel>> Search([FromBody] SearchRequestModel data) =>
            base.Search(data);
        ...
        [Route("create")]
        [PermissionRequired(Permissions.AuditRailDailyAudit)]
        public override ValidationResultWithFieldsErrorsViewModel Create([FromBody] DailyAuditRuleEditModel model) => base.Create(model);
        ...
        [Route("update")]
        [PermissionRequired(Permissions.AuditRailDailyAudit)]
        public override ValidationResultWithFieldsErrorsViewModel Update([FromBody] DailyAuditRuleEditModel model) => base.Update(model);
        ...
        [Route("getNew")]
        [PermissionRequired(Permissions.AuditRailDailyAudit)]
        public override DailyAuditRuleViewModel GetNewRow() => base.GetNewRow();
