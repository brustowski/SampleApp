...
namespace FilingPortal.Web.Controllers.VesselExport
{
    ...
    /// </summary>
    [RoutePrefix("api/export/vessel/filing")]
    public class VesselExportFilingController : ApiControllerBase
    {
        /// <summary>
        /// The filing procedure service
        /// </summary>
        private readonly IVesselExportFilingService _procedureService;
        ...
        /// </summary>
        private readonly IVesselExportFilingHeadersRepository _filingHeaderRepository;

        /// <summary>
        /// Vessel export filing configuration factory
        /// </summary>
        private readonly IFilingConfigurationFactory<VesselExportDefValuesManualReadModel> _configurationFactory;

        /// <summary>
        /// Initializes a new instance of the <see cref="VesselExportFilingController"/> class
        /// </summary>
        ...
        public VesselExportFilingController(
            IVesselExportFilingService procedureService,
            IVesselExportFilingHeadersRepository filingHeaderRepository,
            IFilingConfigurationFactory<VesselExportDefValuesManualReadModel> configurationFactory,
        ...
        [HttpPost]
        [Route("start")]
        [PermissionRequired(Permissions.VesselFileExportRecord)]
        public IHttpActionResult Start([FromBody] int[] ids)
        {
            using (new MonitoredScope("Starting Filing process"))
            {
                ...
                {
                    VesselExportFilingHeader currentHeader = filingHeaders.FirstOrDefault(x => x.VesselExports.Any(y => y.Id == id));
        ...
        {
            VesselExportFilingHeader filingHeader = _filingHeaderRepository.Get(filingHeaderId);
        ...
        {
            IEnumerable<VesselExportFilingHeader> filingHeaders = _filingHeaderRepository.GetList(filingHeadersId);
        ...
        public IHttpActionResult CancelFilingProcess(IEnumerable<int> ids)
        {
            ...
            {
                IEnumerable<VesselExportFilingHeader> filingHeaders;
        ...
        {
            return _filingHeaderRepository.GetList(filingHeaderIds).SelectMany(x => x.VesselExports.Select(t => t.Id));
        }
