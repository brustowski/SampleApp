...
{
    /// <summary>
    /// Controller provides actions for Vessel Export Default Values
    /// </summary>
    [RoutePrefix("api/rules/export/vessel/default-values")]
    public class VesselExportDefaultValuesController : ApiControllerBase
    {
        /// <summary>
        ...
        /// </summary>
        private readonly IDefValueService<VesselExportDefValue> _service;

        /// <summary>
        /// Initializes a new instance of the <see cref="VesselExportDefaultValuesController" /> class
        /// </summary>
        ...
        public VesselExportDefaultValuesController(
            IPageConfigContainer pageConfigContainer,
            IVesselExportDefValuesReadModelRepository repository,
            ISearchRequestFactory searchRequestFactory,
            IDefValueService<VesselExportDefValue> service)
        {
        ...
        public ValidationResultWithFieldsErrorsViewModel Create([FromBody] DefValuesEditModel model)
        {
            ...
            {
                var defValue = model.Map<DefValuesEditModel, VesselExportDefValue>();
