...
namespace FilingPortal.Domain.Mapping.Converters
{
    ...
    /// </summary>
    public class RailAuditValidationErrorsResolver : IValueResolver<AuditRailDaily, AuditRailDailyAuditReportModel, string>
    {
        private readonly ISingleRecordTypedValidator<FieldsValidationResult, AuditRailDaily> _validator;

        public RailAuditValidationErrorsResolver(
            ...
            ResolutionContext context)
        {
            ...
            return string.Join("; ", errors.Where(x => x.Severity == Severity.Error).Select(x => x.Message));
        }
    }
}
