...
namespace FilingPortal.Domain.Imports.Pipeline.RuleFacility
{
    ...
    internal class Configuration : IImportConfiguration
    {
        ...
        /// </summary>
        public string Name => GridNames.PipelineRuleFacility;

        /// <summary>
        /// Gets the template File Name
        /// </summary>
        public string FileName { get; set; } = $"{GridNames.PipelineRuleFacility}_template";
        ...
        /// </summary>
        public Type ResultType => typeof(PipelineRuleFacility);
        /// <summary>
