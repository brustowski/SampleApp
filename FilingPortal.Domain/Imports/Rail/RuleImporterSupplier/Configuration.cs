...
namespace FilingPortal.Domain.Imports.Rail.RuleImporterSupplier
{
    ...
    internal class Configuration : IImportConfiguration
    {
        ...
        /// </summary>
        public string Name => GridNames.RailRuleImporterSupplier;

        /// <summary>
        /// Gets the template File Name
        /// </summary>
        public string FileName { get; set; } = $"{GridNames.RailRuleImporterSupplier}_template";
        ...
        /// </summary>
        public Type ResultType => typeof(RailRuleImporterSupplier);
        /// <summary>
