...
namespace FilingPortal.Domain.Imports.Admin.AutoCreate
{
    ...
    internal class Configuration : IImportConfiguration
    {
        ...
        /// </summary>
        public string FileName { get; set; } = $"{GridNames.AutoCreateRecords}_template";
        ...
        /// </summary>
        public Type ResultType => typeof(AutoCreateRecord);
        /// <summary>
        /// Gets the required permission collection
        /// </summary>
        public IEnumerable<int> Permissions => new[] { (int)Enums.Permissions.AdminAutoCreateConfiguration };
    }
}
