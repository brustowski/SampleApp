...
namespace FilingPortal.Domain.Common.Reporting.ReportDataSource
{
    ...
    /// </summary>
    internal class TruckExportRecordsDataSource : IReportDatasource
    {
        /// <summary>
        ...
        public TruckExportRecordsDataSource(ITruckExportReadModelRepository searchRepository)
        {
        ...
        /// </summary>
        public string Name => GridNames.TruckExportRecords;
        /// <summary>
        /// Gets the repository
        /// </summary>
        public ITruckExportReadModelRepository SearchRepository { get; }
        /// <summary>
