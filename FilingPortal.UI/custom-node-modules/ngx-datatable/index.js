...
var DataTableBodyRowComponent = /** @class */ (function () {
    ...
    DataTableBodyRowComponent.prototype.calcStylesByGroup = function (group) {
        ...
        if (group === 'left') {
            ...
            var scrollBarWidth = this.scrollbarV ? this.scrollbarHelper.width : 0;
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", Boolean)
    ], DataTableBodyRowComponent.prototype, "scrollbarV", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Number),
        __metadata("design:paramtypes", [Number])
...
var DatatableComponent = /** @class */ (function () {
    function DatatableComponent(scrollbarHelper, dimensionsHelper, cd, element, differs, columnChangesService) {
        ...
        /**
         * A property to control select all behaviour
         */
    ...
    Object.defineProperty(DatatableComponent.prototype, "allRowsSelected", {
        ...
        get: function () {
            var _this = this;
            var allRowsSelected = (this.rows && this.selected &&
                this.rows.every(function (x) { return _this.selected.find(function (y) { return _this.rowIdentity(x) === _this.rowIdentity(y); }); }));
    ...
    Object.defineProperty(DatatableComponent.prototype, "fullHeight", {
        get: function () {
            var result = this.headerHeight + this.footerHeight;
            if (this.bodyComponent.scrollHeight) {
                result += this.bodyComponent.scrollHeight;
            }
            else if (this.bodyComponent.scroller) {
                result += this.bodyComponent.scroller.element.scrollHeight;
            }
            if (this.bodyComponent.scroller && this.bodyComponent.scroller.scrollWidth > this.bodyComponent.innerWidth) {
                result += this.scrollbarHelper.width;
            }
            return result;
        },
        enumerable: true,
    ...
    */
    ...
    /**
     * Recalc's the sizes of the grid and updates the view.
     *
     * Updated automatically on changes to:
     *
     *  - Columns
     ...
     * Also can be manually invoked or upon window resize.
     */
    DatatableComponent.prototype.recalculateAndUpdateView = function () {
        this.recalculate();
    ...
    DatatableComponent.prototype.onHeaderSelect = function (event) {
        ...
        if (this.selectAllRowsOnPage) {
            ...
            // before we splice, chk if we currently have all selected
            var allSelected = (this.rows && this.selected &&
                this.rows.every(function (x) { return _this.selected.find(function (y) { return _this.rowIdentity(x) === _this.rowIdentity(y); }); }));
            // remove all existing either way
            this.selected = this.selected.filter(function (x) { return _this.rows.find(function (y) { return _this.rowIdentity(x) === _this.rowIdentity(y); }) === undefined; });
            // do the opposite here
            if (!allSelected) {
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", Boolean)
    ], DatatableComponent.prototype, "selectAllEnabled", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
...
var DataTableHeaderCellComponent = /** @class */ (function () {
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", Boolean)
    ], DataTableHeaderCellComponent.prototype, "selectAllEnabled", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ...
    DataTableHeaderCellComponent = __decorate([
        core_1.Component({
            ...
            template: "\n    <div class=\"datatable-header-cell-template-wrap\">\n      <ng-template\n        *ngIf=\"isTarget\"\n        [ngTemplateOutlet]=\"targetMarkerTemplate\"\n        [ngTemplateOutletContext]=\"targetMarkerContext\">\n      </ng-template>\n        <input\n          *ngIf=\"isCheckboxable\"\n          id=\"checkbox_{{column.name}}\"\n          type=\"checkbox\"\n          [checked]=\"allRowsSelected\"\n          (change)=\"select.emit(!allRowsSelected)\"\n        />\n        <label *ngIf=\"isCheckboxable\" [for]=\"'checkbox_' + column.name\" class=\"datatable-checkbox\"></label>\n      <span\n        *ngIf=\"!column.headerTemplate\"\n        class=\"datatable-header-cell-wrapper\">\n        <span\n          class=\"datatable-header-cell-label draggable\"\n          (click)=\"onSort()\"\n          [innerHTML]=\"name\">\n        </span>\n      </span>\n      <ng-template\n        *ngIf=\"column.headerTemplate\"\n        [ngTemplateOutlet]=\"column.headerTemplate\"\n        [ngTemplateOutletContext]=\"cellContext\">\n      </ng-template>\n      <span\n        (click)=\"onSort()\"\n        [class]=\"sortClass\">\n      </span>\n    </div>\n  ",
            host: {
...
var DataTableHeaderComponent = /** @class */ (function () {
    function DataTableHeaderComponent(cd, scrollbarHelper) {
        this.cd = cd;
        this.scrollbarHelper = scrollbarHelper;
        this.sort = new core_1.EventEmitter();
        this.reorder = new core_1.EventEmitter();
    ...
    DataTableHeaderComponent.prototype.calcStylesByGroup = function (group) {
        ...
        if (group === 'center') {
            ...
            var offset = (totalDiff + scrollBarWidth) * -1;
            utils_1.translateXY(styles, offset, 0);
        }
        return styles;
    };
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", Boolean)
    ], DataTableHeaderComponent.prototype, "scrollbarV", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", Boolean)
    ], DataTableHeaderComponent.prototype, "selectAllEnabled", void 0);
    __decorate([
        core_1.HostBinding('style.height'),
        core_1.Input(),
        __metadata("design:type", Object),
...
var DatatableRowDetailDirective = /** @class */ (function () {
    function DatatableRowDetailDirective(cdr) {
        this.cdr = cdr;
        this._rowHeight = 0;
        /**
    ...
    Object.defineProperty(DatatableRowDetailDirective.prototype, "rowHeight", {
        get: function () {
            return this._rowHeight;
        },
        /**
    ...
    __decorate([
        ...
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], DatatableRowDetailDirective.prototype, "rowHeight", null);
    __decorate([
        core_1.Input(),
