...
@Component({
  selector: 'lxft-daily-audit-rules',
  templateUrl: './daily-audit-rules.component.html'
})
export class DailyAuditRulesComponent extends GridPageCtrl implements OnInit {
