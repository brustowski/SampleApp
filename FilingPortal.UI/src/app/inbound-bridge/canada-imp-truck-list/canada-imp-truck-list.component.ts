...
import { AvailableActions, CanadaImpTruckPageConfigNames, HighlightingType } from '@common/models';
...
@Component({
  selector: 'lxft-canada-imp-truck-list',
  templateUrl: './canada-imp-truck-list.component.html'
})
export class CanadaImpTruckListComponent extends CommonInboundList implements OnInit {
  get massUploadUrl(): string {
    return 'canada-imp-truck/documents-upload';
  }
  ...
  setPageAvailableActions(): void {
    this.configurationService
      .getPageActions(CanadaImpTruckPageConfigNames.InboundViewPageActions)
