...
@Component({
  selector: 'lxft-vessel-list',
  templateUrl: './vessel-list.component.html'
})
export class VesselListComponent extends CommonInboundList implements OnInit {
  ...
  get massUploadUrl(): string {
    return 'inbound/vessel/documents-upload';
  }
  ...
  setPageAvailableActions(): void {
    this.configurationService
      .getPageActions(PageConfigNames.VesselViewPageActions)
