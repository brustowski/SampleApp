...
import { AvailableActions, HighlightingType } from '@common/models';
import { ZonesInBondPageConfigNames } from '@common/models/zones-inbond-models';
...
@Component({
  selector: 'lxft-inbond-list',
  templateUrl: './inbond-list.component.html'
})
export class InbondListComponent extends CommonInboundList implements OnInit {
  ...
  setPageAvailableActions(): void {
    this.configurationService
      .getPageActions(ZonesInBondPageConfigNames.InbondViewPageActions)
