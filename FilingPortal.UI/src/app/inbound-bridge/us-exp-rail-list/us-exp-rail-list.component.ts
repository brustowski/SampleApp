...
import { AvailableActions, HighlightingType, UsExpRailPageConfigNames } from '@common/models';
...
@Component({
  selector: 'lxft-us-exp-rail-list',
  templateUrl: './us-exp-rail-list.component.html'
})
export class UsExpRailListComponent extends CommonInboundList implements OnInit {
  ...
  setPageAvailableActions(): void {
    this.configurationService
      .getPageActions(UsExpRailPageConfigNames.InboundViewPageActions)
      .subscribe(result => (this.pageAvailableActions = result));
  }

  get massUploadUrl(): string {
    return 'export/rail/documents-upload';
  }
