...
@Component({
  selector: 'lxft-file-upload-validation-result',
  templateUrl: './file-upload-validation-result.component.html'
})
export class FileUploadValidationResultComponent extends ModalCtrl implements OnInit {
