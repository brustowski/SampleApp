...
namespace FilingPortal.Parts.Recon.DataLayer.Tests.Web.GridConfigs
{
    [TestClass]
    public class GridConfigsTests: GridConfigsTestsBase
    {
        public override Assembly ConfigsAssembly => Assembly.GetAssembly(typeof(Recon.Web.AutofacModule));
