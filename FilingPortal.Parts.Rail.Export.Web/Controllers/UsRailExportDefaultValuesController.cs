...
namespace FilingPortal.Parts.Rail.Export.Web.Controllers
{
    ...
    /// </summary>
    [RoutePrefix("api/rules/us/export/rail/default-values")]
    public class UsRailExportDefaultValuesController : DefaultValuesControllerBase<DefValueReadModel, DefValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsRailExportDefaultValuesController" /> class
        /// </summary>
        ...
        public UsRailExportDefaultValuesController(
