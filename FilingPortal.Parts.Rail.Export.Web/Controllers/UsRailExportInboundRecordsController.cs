...
using FilingPortal.Parts.Rail.Export.Domain.Commands;
...
namespace FilingPortal.Parts.Rail.Export.Web.Controllers
{
    ...
    public class UsRailExportInboundRecordsController : InboundControllerBase<InboundReadModel, InboundRecordViewModel>
    {
        private readonly ICommandDispatcher _commandDispatcher;

        /// <summary>
        /// Initializes a new instance of the <see cref="UsRailExportInboundRecordsController"/> class.
        /// </summary>
        ...
        public UsRailExportInboundRecordsController(
