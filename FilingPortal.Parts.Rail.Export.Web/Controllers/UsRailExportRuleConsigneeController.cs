...
{
    /// <summary>
    /// Controller provides actions for Consignee Rule 
    /// </summary>
    [RoutePrefix("api/rules/export/rail/consignee")]
    public class UsRailExportRuleConsigneeController : RuleControllerBase<RuleConsignee, RuleConsigneeViewModel, RuleConsigneeEditModel>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UsRailExportRuleConsigneeController" /> class
        /// </summary>
        ...
        public UsRailExportRuleConsigneeController(
            IPageConfigContainer pageConfigContainer,
            ISearchRequestFactory searchRequestFactory,
            IRuleRepository<RuleConsignee> repository,
            IRuleService<RuleConsignee> ruleService,
            IRuleValidator<RuleConsignee> ruleValidator
            )
        ...
        [Route("search")]
        [PermissionRequired(Permissions.ViewRules)]
        public override Task<SimplePagedResult<RuleConsigneeViewModel>> Search([FromBody]SearchRequestModel data) => base.Search(data);
        ...
        public override ValidationResultWithFieldsErrorsViewModel Update([FromBody] RuleConsigneeEditModel model) => base.Update(model);
        ...
        [Route("create")]
        [PermissionRequired(Permissions.EditRules)]
        public override ValidationResultWithFieldsErrorsViewModel Create([FromBody] RuleConsigneeEditModel model) => base.Create(model);
        ...
        [Route("getNew")]
        [PermissionRequired(Permissions.EditRules)]
        public override RuleConsigneeViewModel GetNewRow() => base.GetNewRow();
        ...
        {
            result.AddFieldError(PropertyExpressionHelper.GetPropertyName<RuleConsigneeEditModel>(x => x.ConsigneeCode),
                string.Empty);
        }
    }
}