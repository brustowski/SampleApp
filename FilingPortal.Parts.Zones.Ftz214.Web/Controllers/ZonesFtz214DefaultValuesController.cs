...
namespace FilingPortal.Parts.Zones.Ftz214.Web.Controllers
{
    ...
    /// </summary>
    [RoutePrefix("api/rules/zones/ftz-214/default-values")]
    public class ZonesFtz214DefaultValuesController : DefaultValuesControllerBase<DefValueReadModel, DefValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ZonesFtz214DefaultValuesController" /> class
        /// </summary>
        ...
        public ZonesFtz214DefaultValuesController(
