...
namespace FilingPortal.Parts.Zones.Ftz214.Web.Mappings
{
    /// <summary>
    ...
    public class DomainToViewModelProfile : Profile
    {
        ...
        public DomainToViewModelProfile()
        {
            ...
            CreateMap<InboundRecord, InboundRecordViewModel>()
                .ForMember(d => d.AdmissionNo, opt => opt.MapFrom(s => s.InboundParsedData.AdmissionNo))
                .ForMember(d => d.AdmissionYear, opt => opt.MapFrom(s => s.InboundParsedData.AdmissionYear));
