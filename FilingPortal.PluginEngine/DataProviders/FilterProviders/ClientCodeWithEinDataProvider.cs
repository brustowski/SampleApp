...
{
    /// <summary>
    /// Provider for importer lookup data provider with code in value
    /// </summary>
    public class ClientCodeWithEinDataProvider : IFilterDataProvider
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientCodeWithEinDataProvider"/> class
        /// </summary>
        /// <param name="repository">Client table repository</param>
        public ClientCodeWithEinDataProvider(IClientRepository repository)
        {
        ...
        public IEnumerable<LookupItem> GetData(SearchInfo searchInfo)
        {
            ...
            return data.Select(x => new LookupItem { DisplayValue = $"{x.ClientCode} - {x.ClientName} {GetEin(x)}", Value = x.ClientCode });
        }
