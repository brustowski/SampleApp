...
namespace FilingPortal.PluginEngine.DataProviders
{
    ...
    /// </summary>
    public class AllClientsDataProvider : ILookupDataProvider
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllClientsDataProvider"/> class
        /// </summary>
        /// <param name="repository">Client table repository</param>
        public AllClientsDataProvider(IClientRepository repository)
        {
        ...
        /// </summary>
        public string Name => DataProviderNames.AllClients;
