...
LEFT JOIN canada_imp_truck.form_configuration AS dependency
...
-- review mapped data
ALTER PROCEDURE canada_imp_truck.sp_review_entry (@filingHeaderIds VARCHAR(MAX)
...
BEGIN
  ...
  SET @values = (SELECT
    ...
    FROM canada_imp_truck.form_configuration AS defValue
    LEFT JOIN canada_imp_truck.form_configuration AS dependancy
