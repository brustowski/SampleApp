INSERT INTO canada_imp_truck.handbook_service_option (code, description) VALUES
 ('125', 'Pre-Arrival EDI transaction containing data required for release purposes, may include Appraisal Quality data at time of submission')
,('257', 'Post-Arrival EDI transaction containing data required for release purposes, may include Appraisal Quality data at time of submission')
,('455', 'An AQ transaction following up a previously submitted Minimum PARS or Post-Arrival RMD. Or, Appraisal Quality invoice data applicable to previously released FIRST package')
,('463', 'Pre-Arrival EDI transactions containing Appraisal Quality data required for release, including CFIA or OGD data elements')
,('471', 'Post-Arrival EDI transactions containing Appraisal Quality data required for release, including CFIA or OGD data elements')
