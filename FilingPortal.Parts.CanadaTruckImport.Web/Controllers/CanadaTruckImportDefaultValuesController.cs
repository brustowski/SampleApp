...
namespace FilingPortal.Parts.CanadaTruckImport.Web.Controllers
{
    ...
    /// </summary>
    [RoutePrefix("api/rules/canada/import/truck/default-values")]
    public class CanadaTruckImportDefaultValuesController : DefaultValuesControllerBase<DefValueReadModel, DefValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CanadaTruckImportDefaultValuesController" /> class
        /// </summary>
        ...
        public CanadaTruckImportDefaultValuesController(
