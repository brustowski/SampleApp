...
namespace FilingPortal.Parts.CanadaTruckImport.Web.Controllers
{
    ...
    /// </summary>
    [RoutePrefix("mvc/canada/import/truck/filing")]
    public class CanadaTruckImportFilingActionsController : Controller
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CanadaTruckImportFilingActionsController" /> class
        /// </summary>
        ...
        public CanadaTruckImportFilingActionsController(
