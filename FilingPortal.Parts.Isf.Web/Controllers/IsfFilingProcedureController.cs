...
using Permissions = FilingPortal.Parts.Isf.Domain.Enums.Permissions;
...
namespace FilingPortal.Parts.Isf.Web.Controllers
{
    ...
    /// </summary>
    [RoutePrefix("api/isf/filing")]
    public class IsfFilingProcedureController : ApiControllerBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IsfFilingProcedureController"/> class
        /// </summary>
        ...
        public IsfFilingProcedureController(
