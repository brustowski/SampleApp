...
namespace FilingPortal.Parts.Inbond.Domain.Validators
{
    ...
    /// </summary>
    public class InbondListValidator : IListInboundValidator<InboundReadModel>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InbondListValidator" /> class
        /// </summary>
        ...
        public InbondListValidator(
            IInboundReadModelRepository readModelRepository,
            IFilingHeaderRepository filingHeadersRepository)
        {
        ...
        private bool ValidateRules(IList<InboundReadModel> records)
        {
        ...
        public string ValidateBeforeSave(int filingHeaderId)
        {
            ...
            {
                IEnumerable<int> ids = filingHeader.InbondRecords.Select(x => x.Id);
