...
DELETE FROM zones_entry.form_configuration WHERE section_id = @header_id and column_name = 'charges'

-- certify cargo release

ALTER TABLE zones_entry.declaration
  DROP COLUMN certify_cargo_release
GO
...
DELETE FROM  zones_entry.form_configuration  WHERE section_id = @decl_id and column_name = 'certify_cargo_release'
GO
