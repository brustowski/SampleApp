...
INSERT zones_entry.form_configuration (section_id, column_name, created_user, display_on_ui, manual, editable, mandatory, description, label, handbook_name, confirmation_needed, has_default_value)
  VALUES (@header_id, 'charges', SUSER_NAME(), 13, 0, CONVERT(BIT, 'True'), CONVERT(BIT, 'False'), NULL, 'Total Charges', NULL, CONVERT(BIT, 'False'), CONVERT(BIT, 'False'))

--- certify cargo release

ALTER TABLE zones_entry.declaration
ADD certify_cargo_release BIT DEFAULT 0
GO
...
INSERT zones_entry.form_configuration (section_id, column_name, created_user, display_on_ui, manual, editable, mandatory, description, label, handbook_name, confirmation_needed, has_default_value)
  VALUES (@decl_id, 'certify_cargo_release', SUSER_NAME(), 13, 0, CONVERT(BIT, 'True'), CONVERT(BIT, 'False'), NULL, 'Certify Cargo Release', NULL, CONVERT(BIT, 'False'), CONVERT(BIT, 'True'))
  GO
...
SELECT
 ...
 ,IIF(declaration.enable_entry_sum = 1, 'Y', 'N') AS declaration_enable_entry_sum
 ,IIF(declaration.enable_cargo_rel = 1, 'Y', 'N') AS declaration_enable_cargo_rel
 ,IIF(declaration.certify_cargo_release = 1, 'Y', 'N') AS declaration_certify_cargo_release
 ...
 ,invoice.charges AS invoice_charges
