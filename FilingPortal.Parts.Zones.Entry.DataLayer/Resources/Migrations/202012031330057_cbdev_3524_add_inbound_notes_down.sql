...
DELETE FROM zones_entry.form_configuration where section_id = 8
GO

DELETE FROM zones_entry.form_section_configuration where id = 8
GO

DROP PROCEDURE IF EXISTS zones_entry.sp_add_notes
GO

DROP TABLE IF EXISTS zones_entry.notes
GO