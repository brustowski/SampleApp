...
add  epa_pst varchar(5) NULL,epa_pst_disclaimer varchar(5) NULL
go
...
BEGIN
  ...
  , created_user)
    SELECT
     ...
     ,inbnd_lines.ftz_manifest_qty
     ,dbo.fn_app_unit_by_tariff(inbnd_lines.hts, 'hts')
...
SELECT
 ...
 ,line.epa_pst as line_epa_pst
 ,line.epa_pst_disclaimer as line_epa_pst_disclaimer
