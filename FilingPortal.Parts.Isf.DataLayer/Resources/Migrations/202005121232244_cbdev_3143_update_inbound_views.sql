...
('isf','AIO','Awaiting ISF Add'),
('isf','AID','Awaiting ISF Delete'),
('isf','AIR','Awaiting ISF Replace'),
('isf','CIO','Clear ISF Add'),
('isf','CID','Clear ISF Delete'),
('isf','CIR','Clear ISF Replace'),
('isf','WIO','Clear With Warning ISF Add'),
('isf','WID','Clear With Warning ISF Delete'),
('isf','WIR','Clear With Warning ISF Replace'),
('isf','EIO','Error ISF Add'),
('isf','EID','Error ISF Delete'),
('isf','EIR','Error ISF Replace'),
('isf','NOT','Not Sent');
GO
